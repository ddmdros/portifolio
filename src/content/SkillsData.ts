...
export const SKILLS_DATA: SkillType[] = [
  ...
  },
  {
    ...
    categoryKey: "about.stacks.programming.languages",
    name: "JavaScript",
    showInResume: ["general", "frontend", "fullstack"]
  },
  {
    id: "s3",
    categoryKey: "about.stacks.programming.languages",
  ...
  },
  {
    ...
    categoryKey: "about.stacks.programming.languages",
    name: "C#",
    showInResume: ["backend", "fullstack"],
  ...
  },
  {
    ...
    categoryKey: "about.stacks.web.game.dev",
    name: "TypeScript",
    showInResume: ["general", "frontend", "fullstack", "backend", "cloud", "ia_ml"],
  ...
  },
  {
    ...
    categoryKey: "about.stacks.web.game.dev",
    name: "Vite",
    showInResume: ["frontend", "fullstack"]
  },
  {
    id: "s9",
    categoryKey: "about.stacks.web.game.dev",
  ...
  // Data & DevOps
  {
    ...
    name: "PostgreSQL",
    showInResume: ["backend", "fullstack", "ia_ml"]
  },
  {
    id: "s14",
    categoryKey: "about.stacks.data.devops",
    name: "Git & CI/CD",
    showInResume: ["general", "cloud", "backend", "frontend", "fullstack", "ia_ml"]
  },
  {
    id: "s15",
    categoryKey: "about.stacks.data.devops",
  ...
  },
  {
    ...
    categoryKey: "about.stacks.data.devops",
    name: "Supabase",
    showInResume: ["backend", "frontend", "fullstack"]
  },
  // Languages
  {
    id: "s17",
